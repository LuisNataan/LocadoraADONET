...
namespace DataAccessLayer
{
    ...
    //        command.CommandText = @"DELETE FROM FUNCIONARIOS
    //                                WHERE ID = @ID";
    ...
    //            {
    //                response.Sucesso = false;
    //                response.Erros.Add("ID do funcionário não informado.");
    //                return response;
    //            }
    //            response.Sucesso = true;
    //            return response;
    ...
    //                Funcionario f = new Funcionario(Convert.ToInt32(reader["ID"]),
    //                                   (string)reader["NOME"],
    //                                   (string)reader["EMAIL"],
    //                                   (string)reader["CPF"],
    ...
    //        command.CommandText = @"UPDATE FUNCIONARIOS SET NOME = @NOME,
    //                                                  EMAIL = @EMAIL, 
    //                                                  CPF = @CPF,
