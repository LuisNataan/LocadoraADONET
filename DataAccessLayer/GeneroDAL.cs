...
namespace DataAccessLayer
{
    ...
    //        command.CommandText = @"UPDATE GENEROS SET NOME = @NOME
    //                                                  WHERE ID = @ID";
    ...
    //            {
    //                response.Sucesso = false;
    //                response.Erros.Add("ID do genêro não informado.");
    //                return response;
    //            }
    //            response.Sucesso = true;
    //            return response;
    ...
    //        command.CommandText = @"DELETE FROM GENEROS
    //                                WHERE ID = @ID";
    ...
    //            {
    //                response.Sucesso = false;
    //                response.Erros.Add("ID do gênero não informado.");
    //                return response;
    //            }
    //            response.Sucesso = true;
    //            return response;
    ...
    //            if (ex.Message.Contains("UQ_GENEROS_NOME"))
    //            {
    //                response.Erros.Add("Este gênero possui ao menos um filme vinculado.");
    //            }
    //            else
    //            {
    //                response.Erros.Add("Erro no banco de dados, contate o administrador!");
